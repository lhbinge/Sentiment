...
@Hart2015 investigated the relationship between sentiment and economy activity in South Africa. The BER's survey of the manufacturing sector was used to construct firm-level measures of uncertainty and confidence, as well as trends in production, employment and investment. An SVAR approach was then used to estimate the impact of uncertainty and confidence shocks on production, investment and employment within the South African manufacturing sector. None of the uncertainty measures were found to be significant, probably due to the small sample size. The study was closely based on @Bachmann2010, which also measured uncertainty in a manufacturing sector using micro-level data. The Ifo survey is also closely comparable to the BER business survey. This paper will build on this approach, expanding the study to include all of the surveyed sectors for the full available sample period.
...
Thus, respondents to compare the current situation with that of a year ago, whereas other surveys often use the previous period for comparison. This provides a qualitative measure of the current conditions relative to levels in the same quarter of the previous year and is therefore equivalent to the year-on-year growth rate in each quarter. The cyclical profiles are therefore easier to detect because they contain no trend. They are usually considered in a growth cycle or growth rate cycle because of their trend free nature [@OECD2003]. It also implies that seasonal adjustment is not required.[^16]
...
Many institutions also calculate confidence measures based on a set of survey variables. These composite indicators may achieve a better trade-off between responsiveness and stability. Composite indicators can be constructed to have fewer false alarms and fewer missed turning points than its individual components and they tend to have more stable lead-times. They also have the capacity to react to various sources of economic fluctuations and at the same time can be resilient to perturbations affecting only one of the components [@ECB2013]. For instance, the EC builds composite indicators by aggregating the survey responses from combinations of questions for five sectors. The industrial indicator is an average of the balances of questions relating to production expectations, order books and stocks of finished goods (with the inverted sign). The construction indicator is an average of the balances of questions on total order books and employment future tendency. The retail trade indicator is an average of the balances to questions relating to present and future business situation and stocks (with the inverted sign). The services indicator relates to questions on present business situation, and past and future demand [@OECD2003].[^17]

[^17]: We could easily make similar composite indicators? For instance we could combine the balances for the questions on production volumes, order, etc.
...
[^18]: Bachmann et al (2010) and Hart (2015) also construct 4 measures of activity from the survey data: production, investment and employment and employment turnover. The questions on investment are not present in all of the surveys. But I have calculated the measures production, employment, and employment turnover (which just adds the fractions of respondents indicating "up" and "down". It is not yet clear if these will be useful, as we have official statistics on production and employment.
...
Figure 1 illustrates the two weighted aggregate confidence indicators for current conditions, as well as the weighted aggregate forward-looking confidence index.[^20] They seem to follow a similar cyclical trend over the business cycle, and the forward-looking index seems to lead the other two indices to some extent. The same is true of the respective sectoral indicators, even though their trends are slightly different (and they have some missing quarters). The two indicators generated from the question on general business conditions do not increase as substantially as the other indicator over the protracted upswing phase from around 2003 to 2007, which is a feature of all of the respective sector indicators. 

[^20]: We could also take the geometric mean of the indices and then normalise it to the average of the base year, as the Ifo does? The indicators may also be generated from firm-specific questions on production, instead of the question on general business conditions. As found in the literature, the indicators generated from the more firm-specific questions are very highly correlated to the indicators for general business conditions. Previous studies have concluded that answers on general business conditions are essentially indicators of firm-specific business conditions.

```{r figure1, echo=FALSE, warning=FALSE, cache = TRUE, fig.height=4.5, fig.width=7.5, fig.cap="Weighted Confidence Indicators"}
...
Figure 3 and Figure 4 compare the aggregate weighted and unweighted versions of the confidence indicators (i.e. the first activity indicator and the forward-looking indicator). The unweighted versions are calculated by stacking all of the available responses from all of the surveys are therefore completely unweighted. In both cases they are very similar, with the weighted versions slightly more volatile than the unweighted indicators. Thus, the specific weighting turns out to have very little impact on the confidence indices. This should give us confidence that the specific weighting adopted does not significantly alter the results. The same is true of the respective sector indices, not illustrated here.
...
```{r manufact.uncert, echo=FALSE, results='hide', message=FALSE, warning=FALSE, cache = TRUE}
