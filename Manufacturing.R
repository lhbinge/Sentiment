...
indicator_plot <- cbind(Manufacturing[,c("Datum","Q20")],Food[,c("Q20")],Textiles[,c("Q20")])
colnames(indicator_plot) <- c("Date","Total","Food","Textiles")
indicator_plot <- melt(indicator_plot, id="Date")  # convert to long format
g1 <- ggplot(data=indicator_plot,aes(x=Date, y=value, group=variable, colour=variable)) 
g1 <- g1 + geom_line()
g1 <- g1 + ylab("Indicator") + xlab("")
...
indicator_plot <- cbind(Wood[,c("Datum","Q20")],Chemicals[,c("Q20")],Glass[,c("Q20")])
colnames(indicator_plot) <- c("Date","Wood","Chemicals","Glass")
indicator_plot <- melt(indicator_plot, id="Date")  # convert to long format
g2 <- ggplot(data=indicator_plot,aes(x=Date, y=value, group=variable, colour=variable)) 
g2 <- g2 + geom_line()
g2 <- g2 + ylab("") + xlab("")
...
indicator_plot <- cbind(Metals[,c("Datum","Q20")],Elec_radio[,c("Q20")])
colnames(indicator_plot) <- c("Date","Metals","Electric & Radio")
indicator_plot <- melt(indicator_plot, id="Date")  # convert to long format
g3 <- ggplot(data=indicator_plot,aes(x=Date, y=value, group=variable, colour=variable)) 
g3 <- g3 + geom_line()
g3 <- g3 + ylab("Indicator") + xlab("")
...
indicator_plot <- cbind(Transport[,c("Datum","Q20")],Furniture[,c("Q20")])
colnames(indicator_plot) <- c("Date","Transport","Furniture")
indicator_plot <- melt(indicator_plot, id="Date")  # convert to long format
g4 <- ggplot(data=indicator_plot,aes(x=Date, y=value, group=variable, colour=variable)) 
g4 <- g4 + geom_line()
g4 <- g4 + ylab("") + xlab("")
...
indicator_plot <- cbind(Consumer[,c("Datum","Q20")],Intermediate[,c("Q20")],Capital[,c("Q20")])
colnames(indicator_plot) <- c("Date","Consumer Goods","Intermediate Goods","Capital Goods")    
indicator_plot <- melt(indicator_plot, id="Date")  # convert to long format
g <- ggplot(data=indicator_plot,aes(x=Date, y=value, group=variable, colour=variable)) 
g <- g + geom_line()
g <- g + ylab("Indicator") + xlab("")
...
indicator_plot <- cbind(Wood[,c("Datum","Q1A")],ref[,c("Wood.sa")])
indicator_plot[,-1] <- scale(indicator_plot[,-1])
colnames(indicator_plot) <- c("Date","Microdata","StatsSA")
indicator_plot <- melt(indicator_plot, id="Date")  # convert to long format
g3 <- ggplot(data=indicator_plot,aes(x=Date, y=value, group=variable, colour=variable)) 
...
indicator_plot <- cbind(Chemicals[,c("Datum","Q1A")],ref[,c("Chemical")])
indicator_plot[,-1] <- scale(indicator_plot[,-1])
colnames(indicator_plot) <- c("Date","Microdata","StatsSA")
indicator_plot <- melt(indicator_plot, id="Date")  # convert to long format
g4 <- ggplot(data=indicator_plot,aes(x=Date, y=value, group=variable, colour=variable)) 
