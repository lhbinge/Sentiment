...
```{r figure01, echo=FALSE, warning=FALSE, cache = TRUE, fig.height=4.5, fig.width=7.5}
...
```{r figure02, echo=FALSE, warning=FALSE, cache = TRUE, fig.height=4.5, fig.width=7.5}
...
Contemporaneous correlations are relatively low
...
##New Weights
###New Weights
We still need to add series calculated with
...
##New Weights
###New Weights
We still need to try alternative weights
...
```{r table01, echo=FALSE, results='asis', warning=FALSE, message=FALSE, cache = TRUE}
...
source("corstarsl.R")
xt <- xtable(corstarsl(motor_trade)[5:6,1:4], caption="Correlations of motor vehicle series")
print(xt, "latex",comment=FALSE,scalebox = 0.6,
      caption.placement = getOption("xtable.caption.placement", "top"))
...
```{r table02, echo=FALSE, results='asis', warning=FALSE, message=FALSE, cache = TRUE}
source("corstarsl.R")
...
xt <- xtable(xt, caption="Correlations of regional series")
print(xt, "latex",comment=FALSE,scalebox = 0.6,
      caption.placement = getOption("xtable.caption.placement", "top"))
...
xt <- xtable(V, caption="Volatility of regional series")
print(xt, "latex",comment=FALSE,scalebox = 0.6,
      caption.placement = getOption("xtable.caption.placement", "top"))
```
